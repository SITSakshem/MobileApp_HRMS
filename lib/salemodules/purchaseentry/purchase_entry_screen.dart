...
import 'package:hrms/salemodules/purchaseentry/sale_order_cart_screen.dart';
...
class _PurchaseEntryScreenState extends State<PurchaseEntryScreen> {
  ...
  late String dateDate = dateFormatter.format(now);
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                InkWell(
                  onTap: () {
                    showDatePicker(context: context, initialDate: DateTime.now(), firstDate: DateTime(now.year), lastDate: DateTime(now.year + 1))
                        .then((value) {
                      setState(() {
                        dateDate = dateFormatter.format(value ?? DateTime.now());
                      });
                    });
                  },
                  child: RoundedBox(
                ...
                hSpacer(12),
                const FormThemedText('Purchase Date'),
                InkWell(
                  onTap: () {
                    showDatePicker(
                      context: context,
                      initialDate: DateTime.now(),
                      firstDate: DateTime.now().subtract(const Duration(days: 7)), // 7 days ago
                      ...
                      ...getStoreItemData.map((item) {
                        return TableRow(
                          children: [
                            ...
                            //     onPressed: item.itemRate!.isNotEmpty ? () => toggleItemInCart(item) : null,
