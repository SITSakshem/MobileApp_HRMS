...
import 'package:hrms/salemodules/saleorderbooking/sale_order_cart_screen.dart';
...
class SaleOrderBookingScreen extends StatefulWidget {
  const SaleOrderBookingScreen({super.key});

  @override
  State<SaleOrderBookingScreen> createState() => _SaleOrderBookingScreenState();
}

class _SaleOrderBookingScreenState extends State<SaleOrderBookingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Sale Order Booking'),
        actions: [
          Padding(
