...
class GetStoreReportResponse {
  GetStoreReportResponse({
      num? messageType, 
      dynamic error, 
      String? message, 
      List<GetStoreList>? data,
      dynamic token,}){
  ...
  GetStoreReportResponse.fromJson(dynamic json) {
    ...
    if (json['returnId'] != null) {
      ...
      json['returnId'].forEach((v) {
        _data?.add(GetStoreList.fromJson(v));
      });
    }
    _token = json['token'];
  }
  ...
  dynamic _error;
  String? _message;
  List<GetStoreList>? _data;
  dynamic _token;
  GetStoreReportResponse copyWith({  num? messageType,
  dynamic error,
  String? message,
  List<GetStoreList>? data,
  dynamic token,
}) => GetStoreReportResponse(  messageType: messageType ?? _messageType,
  error: error ?? _error,
  ...
  List<GetStoreList>? get data => _data;
...
class GetStoreList {
  ...
  GetStoreList.fromJson(dynamic json) {
    _id = json['id'];
