...
part of 'outdoor_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

OutdoorReportResponse _$OutdoorReportResponseFromJson(
    ...
    OutdoorReportResponse(
      ...
      data: (json['returnId'] as List<dynamic>)
          .map((e) => OutdoorReport.fromJson(e as Map<String, dynamic>))
          .toList(),
      token: json['token'] as String?,
    );

Map<String, dynamic> _$OutdoorReportResponseToJson(
        OutdoorReportResponse instance) =>
    <String, dynamic>{
...
OutdoorReport _$OutdoorReportFromJson(Map<String, dynamic> json) =>
    OutdoorReport(
...
Map<String, dynamic> _$OutdoorReportToJson(OutdoorReport instance) =>
    <String, dynamic>{
